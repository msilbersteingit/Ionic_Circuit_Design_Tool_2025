...
## Licence:
The code under Modelica is licenced under the [GPLv3](https://www.gnu.org/licenses/gpl-3.0-standalone.html) or later, while everything else is licenced under that license or [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/)
