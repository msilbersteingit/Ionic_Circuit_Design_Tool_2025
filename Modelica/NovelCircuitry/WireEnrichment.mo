...
model WireEnrichment
  package ActivityModel = Ionics.Materials.Activity.Ideal;
  Ionics.Basic.InterfaceSharp interface_a(redeclare package MaterialA = Ionics.Materials.WaterIdeal, redeclare package MaterialB = Nafion_117) annotation(
    Placement(transformation(origin = {-26, 20}, extent = {{-10, -10}, {10, 10}})));
  Ionics.Basic.InterfaceSharp interface_b(redeclare package MaterialA = Nafion_117, redeclare package MaterialB = Ionics.Materials.WaterIdeal) annotation(
    Placement(transformation(origin = {36, 20}, extent = {{-10, -10}, {10, 10}})));
  Ionics.Geometric.UniformPrism load(redeclare package Material = Nafion_117, C_initial = {1.30008e3, 0.08}, initial_source_of_right_concentration_truth = false, length = 1e-4, area = 1e-8, initial_source_of_left_concentration_truth = false, n_seg = 6) annotation(
