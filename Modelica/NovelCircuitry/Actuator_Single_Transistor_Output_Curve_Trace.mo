...
model Actuator_Single_Transistor_Output_Curve_Trace
  ...
  Modelica.Blocks.Sources.CombiTimeTable base_input_voltage1(extrapolation = Modelica.Blocks.Types.Extrapolation.Periodic, smoothness = Modelica.Blocks.Types.Smoothness.LinearSegments, table = {{0, 0.0}, {3000, 3.0}, {6000, 0.0}}) annotation(
  ...
  Modelica.Electrical.Analog.Basic.Resistor resistor(R(displayUnit = "MOhm") = 1e7) annotation(
  ...
  Modelica.Blocks.Sources.CombiTimeTable base_input(table = {{0, 1e-8}, {6000, 0.5e-6}, {12000, 1e-6}, {18000, 2e-6}, {24000, 3e-6}, {30000, 4e-6}}, smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments, extrapolation = Modelica.Blocks.Types.Extrapolation.HoldLastPoint) annotation(
...
equation
  ...
  connect(actuator_enrich_npn.port_d, oscillator_a_upper_wire.port_b) annotation(
    Line(points = {{-82, -98}, {-82, -82}}, color = {0, 85, 0}));
  ...
  connect(actuator_enrich_npn.port_s, oscillator_a_lower_wire.port_a) annotation(
    Line(points = {{-82, -118}, {-82, -138}}, color = {0, 85, 0}));
  connect(V_ds.p, electrode_drain.pin_a) annotation(
    Line(points = {{-162, -104}, {-160, -104}, {-160, -48}, {-148, -48}}, color = {0, 0, 255}));
  connect(base_input.y[1], slew_limit.u) annotation(
    Line(points = {{86, -158}, {72, -158}}, color = {0, 0, 127}));
  annotation(
    uses(Modelica(version = "4.0.0"), Ionics(version = "0.1.0")),
    Diagram(coordinateSystem(extent = {{-340, -20}, {160, -240}})),
    version = "",
    experiment(StartTime = 0, StopTime = 36000, Tolerance = 1e-08, Interval = 1),
    __OpenModelica_simulationFlags(lv = "-LOG_STDOUT,-LOG_ASSERT,LOG_EVENTS,LOG_STATS", s = "dassl", variableFilter = ".*", jacobian = "coloredNumerical", ls = "klu"),
...
end Actuator_Single_Transistor_Output_Curve_Trace;