...
model Oscillator_Single_Transistor_Response
  ...
  Modelica.Electrical.Analog.Sources.ConstantVoltage V_ds(V = 1)  annotation(
    Placement(transformation(origin = {-160, -130}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
equation
  ...
  connect(oscillator_a_lower_wire.port_a, oscillator_a_npn.port_s) annotation(
    Line(points = {{-80, -154}, {-80, -134}}, color = {0, 85, 0}));
  ...
  connect(V_ds.p, electrode_drain.pin_a) annotation(
    Line(points = {{-160, -120}, {-160, -64}, {-146, -64}}, color = {0, 0, 255}));
  connect(V_ds.n, ground.p) annotation(
    Line(points = {{-160, -140}, {-160, -214}}, color = {0, 0, 255}));
...
end Oscillator_Single_Transistor_Response;