...
model Robot_Brain_Changing_Concentration
  ...
  Ionics.Geometric.UniformPrism oscillator_b_upper_wire(C_initial = bath_concentration, redeclare package Material = MaterialBath, area = 1e-9, initial_source_of_right_concentration_truth = true, length = 1e-3, n_seg = 3, k = 1) annotation(
    Placement(transformation(origin = {46, -74}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Ionics.Geometric.UniformPrism oscillator_a_upper_wire(C_initial = bath_concentration, redeclare package Material = MaterialBath, area = 1e-9, initial_source_of_right_concentration_truth = true, length = 1e-3, n_seg = 3, k = 1) annotation(
  ...
  Ionics.Basic.Capacitor oscillator_b_capacitor(redeclare package MaterialA = MaterialBath, redeclare package MaterialB = MaterialBath, area = 0.0002, species_set_a = species_set, species_set_b = species_set, V_delta(start = 0)) annotation(
    Placement(transformation(origin = {22, -98}, extent = {{-10, 10}, {10, -10}})));
  ...
  Ionics.Basic.ConcentrationSignal sensor_concentration_world(redeclare package Material = MaterialBath, species_set = species_set_world)  annotation(
    Placement(transformation(origin = {114, -146}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable(smoothness = Modelica.Blocks.Types.Smoothness.MonotoneContinuousDerivative2, table = {{0, 5}, {11000, 5}, {17000, 50}, {20000, 50}, {26000, 5}, {28001, 5}}, tableOnFile = false) annotation(
    Placement(transformation(origin = {92, -180}, extent = {{-10, -10}, {10, 10}})));
equation
  ...
  connect(sensor_wire_world.port_b, sensor_concentration_world.port) annotation(
    Line(points = {{114, -130}, {114, -136}}, color = {0, 85, 0}));
  connect(combiTimeTable.y, sensor_concentration_world.Ci) annotation(
    Line(points = {{104, -180}, {114, -180}, {114, -154}}, color = {0, 0, 127}, thickness = 0.5));
  annotation(
    uses(Modelica(version = "4.0.0"), Ionics(version = "0.1.0")),
    Diagram(coordinateSystem(extent = {{-340, -20}, {160, -240}}), graphics = {Text(origin = {-27, -203}, extent = {{-33, 5}, {33, -5}}, textString = "Oscillator"), Text(origin = {-197, -205}, extent = {{-33, 5}, {33, -5}}, textString = "Actuator"), Rectangle(origin = {-305, -113}, fillColor = {229, 251, 255}, fillPattern = FillPattern.Solid, extent = {{29, 89}, {-29, -89}}), Text(origin = {-305, -209}, extent = {{-33, 5}, {33, -5}}, textString = "Power Supply"), Rectangle(origin = {-185, -104}, fillColor = {255, 252, 234}, fillPattern = FillPattern.Solid, extent = {{83, 82}, {-83, -82}}), Rectangle(origin = {114, -114}, fillColor = {255, 242, 253}, fillPattern = FillPattern.Solid, extent = {{38, 80}, {-38, -80}}), Text(origin = {113, -201}, extent = {{-33, 5}, {33, -5}}, textString = "Sensor"), Rectangle(origin = {-15, -114}, fillColor = {235, 255, 235}, fillPattern = FillPattern.Solid, extent = {{85, 82}, {-85, -82}})}),
    version = "",
    experiment(StartTime = 0, StopTime = 36000, Tolerance = 1e-08, Interval = 1.5),
...
end Robot_Brain_Changing_Concentration;