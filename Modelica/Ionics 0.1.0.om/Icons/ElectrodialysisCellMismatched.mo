...
partial model ElectrodialysisCellMismatched
...
protected
  ...
  annotation(
    Icon(graphics = {Rectangle(origin = {74, 0}, lineColor = {0, 85, 0}, fillColor = icon_color_electrodialysis_bath, fillPattern = FillPattern.Solid, extent = {{-56, 35}, {0, -35}}),
                     Polygon(origin = {58, 35}, lineColor = {0, 85, 0}, fillColor = icon_color_electrodialysis_bath, fillPattern = FillPattern.Solid, points = {{16, 0}, {-40, 0}, {-70, 10}, {-14, 10}, {16, 0}}),
