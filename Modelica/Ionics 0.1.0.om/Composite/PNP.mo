...
model PNP
  extends Partial.Transistor3Part(drain_junction(V_delta(start = 0.1, fixed)), source_junction_outer(V_delta(start = 0.1, fixed)), base_junction_outer(V_delta(start = 0.1, fixed)), source_junction(V_delta(start = -0.1, fixed)), drain_junction_outer(V_delta(start = -0.1, fixed)));
