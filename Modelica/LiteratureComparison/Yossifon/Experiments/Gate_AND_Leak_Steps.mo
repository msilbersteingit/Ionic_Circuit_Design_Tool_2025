...
model Gate_AND_Leak_Steps
  ...
  constant Real[2] bath_concentration = gate.diode_a.bath_concentration;
...
equation
  ...
  annotation(
    ...
    version = "",
    experiment(StartTime = 0, StopTime = 2400, Tolerance = 1e-09, Interval = 0.6),
